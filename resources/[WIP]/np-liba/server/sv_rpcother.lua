...
RegisterNetEvent('drp-rpc:cl_request')
AddEventHandler('drp-rpc:cl_request', function(origin, name, callId, params)
    local response
    local src = source
    ...
    TriggerClientEvent('drp-rpc:cl_response', src, origin, callId, response)
end)