...
RegisterNetEvent('drp-lib:cl_request')
AddEventHandler('drp-lib:cl_request', function(origin, name, callId, params)
    local response
    local src = source
    ...
    TriggerClientEvent('drp-lib:cl_response', src, origin, callId, response)
end)