...
RPC.execute = function(name, ...)
    ...
    TriggerServerEvent('drp-lib:cl_request', res, name, callId, paramPacker(...))
...
RegisterNetEvent('drp-lib:cl_response')
AddEventHandler('drp-lib:cl_response', function(origin, callId, response)
