...
RPC.execute = function(name, ...)
    ...
    TriggerServerEvent('drp-rpc:cl_request', res, name, callId, paramPacker(...))
...
RegisterNetEvent('drp-rpc:cl_response')
AddEventHandler('drp-rpc:cl_response', function(origin, callId, response)
