...
RegisterNetEvent('srp-rpc:cl_request')
AddEventHandler('srp-rpc:cl_request', function(origin, name, callId, params)
    local response
    local src = source
    ...
    TriggerClientEvent('srp-rpc:cl_response', src, origin, callId, response)
end)