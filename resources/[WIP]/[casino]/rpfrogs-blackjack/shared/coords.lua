...
function DebugPrint(str)
	if _DEBUG == true and str then
		return print("rpfrogs-blackjack: "..tostring(str))
	end
end
...
cardRotationOffsetsDealer = { -- doesnt have to be vector3 but it is
...
chipSplitRotationOffsets = { -- doesnt have to be vector3 but it is
	[1] = {
		vector3(0, 0, -16.56),
		vector3(0, 0, -22.32),
		vector3(0, 0, -10.8),
...
chipRotationOffsets = { -- doesnt have to be vector3 but it is
	[1] = {
		vector3(0, 0, 72.0),
		vector3(0, 0, 64.8),
		vector3(0, 0, 74.52),
...
pileRotationOffsets = { -- can be vector4 or vector 3
	[1] = {
		vector3(0, 0, 8.1),
		vector3(0, 0, 229.49),
		vector3(0, 0, 74.52),
...
bettingNums = {
	...
	40000,
	45000,
	50000, -- High Stakes After (50 Max in low table)
	55000,
	60000,
	65000,
	70000,
