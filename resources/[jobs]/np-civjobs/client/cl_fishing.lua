...
AddEventHandler('np-fishing:start-fishing', function()
    if poleTimer == 0 and fishinglocation1active or fishinglocation2active or fishinglocation3active or fishinglocation4active or fishinglocation5active or fishinglocation6active then 
        TryToFish()
    else
        TriggerEvent('DoLongHudText', 'This isnt your zone or you arent even clocked into fishing', 2)
    end
end)
...
CastBait = function(rodHandle, castLocation)
    ...
    if caughtFish then
        if amount == 1 then
            if fishinglocation6active then                                                     -- If at Ocean Spot
                netamount = math.random(1,3)
                if exports["np-inventory"]:hasEnoughOfItem("fishingnet", 1) then               -- If Has Fishing Net 
                TriggerEvent("player:receiveItem",'fishingalligatorturtle', netamount)
                TriggerEvent("DoLongHudText","Your net caught you some Alligator Snapping Turtles!",1)
                else                                                                           -- If Doesnt Have Fishing Net
                    TriggerEvent("player:receiveItem",'fishingalligatorturtle', 1)  
                    TriggerEvent("DoLongHudText","You managed to catch a Alligator Snapping Turtle!",1)
                end
            else       
                if exports["np-inventory"]:hasEnoughOfItem("illegalhook", 1) then  
                    hookamount = math.random(2,3)                                                  --If Not At Ocean Spot + Has Hook
                      TriggerEvent("player:receiveItem",'fishingbass', hookamount)
                      TriggerEvent("DoLongHudText","Your hook caught you some extra bass!",1)
                else                                                                                -- If Not At Ocean Spot + No Hook
                    TriggerEvent("player:receiveItem",'fishingbass', 1)
                    TriggerEvent("DoLongHudText","You managed to catch a bass!",1)
                end
            end
        end
    ...
    if caughtFish then
        if amount == 2 then
            if fishinglocation6active then                                                     -- If at Ocean Spot
                netamount = math.random(1,3)
                if exports["np-inventory"]:hasEnoughOfItem("fishingnet", 1) then               -- If Has Fishing Net 
                TriggerEvent("player:receiveItem",'fishingsockeyesalmon', netamount)
                TriggerEvent("DoLongHudText","Your net caught you some Stockeye Salmon!",1)
                else                                                                           -- If Doesnt Have Fishing Net
                    TriggerEvent("player:receiveItem",'fishingsockeyesalmon', 1)  
                    TriggerEvent("DoLongHudText","You managed to catch a Stockeye Salmon!",1)
                end
            else       
                if exports["np-inventory"]:hasEnoughOfItem("illegalhook", 1) then  
                    hookamount = math.random(2,3)                                                  --If Not At Ocean Spot + Has Hook
                      TriggerEvent("player:receiveItem",'fishingcarp', hookamount)
                      TriggerEvent("DoLongHudText","Your hook caught you some extra carp!",1)
                else                                                                                -- If Not At Ocean Spot + No Hook
                    TriggerEvent("player:receiveItem",'fishingcarp', 1)
                    TriggerEvent("DoLongHudText","You managed to catch a carp!",1)
                end
            end
        end
    ...
    if caughtFish then
        if amount == 3 then
            if fishinglocation6active then                                                     -- If at Ocean Spot
                netamount = math.random(1,3)
                if exports["np-inventory"]:hasEnoughOfItem("fishingnet", 1) then               -- If Has Fishing Net 
                TriggerEvent("player:receiveItem",'fishingsturgeon', netamount)
                TriggerEvent("DoLongHudText","Your net caught you some Sturgeon!",1)
                else                                                                           -- If Doesnt Have Fishing Net
                    TriggerEvent("player:receiveItem",'fishingsturgeon', 1)  
                    TriggerEvent("DoLongHudText","You managed to catch a Sturgeon!",1)
                end
            else       
                if exports["np-inventory"]:hasEnoughOfItem("illegalhook", 1) then  
                    hookamount = math.random(2,3)                                                  --If Not At Ocean Spot + Has Hook
                      TriggerEvent("player:receiveItem",'fishingcatfish', hookamount)
                      TriggerEvent("DoLongHudText","Your hook caught you some extra catfish!",1)
                else                                                                                -- If Not At Ocean Spot + No Hook
                    TriggerEvent("player:receiveItem",'fishingcatfish', 1)
                    TriggerEvent("DoLongHudText","You managed to catch a catfish!",1)
                end
            end
        end
    ...
    if caughtFish then
        if amount == 4 then
            if fishinglocation6active then                                                     -- If at Ocean Spot
                if exports["np-inventory"]:hasEnoughOfItem("fishingwhale", 1) then               -- If Has Fishing Net 
                TriggerEvent("player:receiveItem",'fishingwhale', 1)
                TriggerEvent("DoLongHudText","Your net caught you a FUCKING WHALE!",1)
                else                                                                           -- If Doesnt Have Fishing Net
                    TriggerEvent("player:receiveItem",'fishingsturgeon', 1)  
                    TriggerEvent("DoLongHudText","You managed to catch a Sturgeon!",1)
                end
                ...
                if exports["np-inventory"]:hasEnoughOfItem("illegalhook", 1) then  
                    hookamount = math.random(2,3)                                                  --If Not At Ocean Spot + Has Hook
                      TriggerEvent("player:receiveItem",'fishingbluefish', hookamount)
                      TriggerEvent("DoLongHudText","Your hook caught you some extra bluegill!",1)
                else                                                                                -- If Not At Ocean Spot + No Hook
                    TriggerEvent("player:receiveItem",'fishingbluefish', 1)
                    TriggerEvent("DoLongHudText","You managed to catch a bluegill!",1)
                end
            end
        end
    ...
    if caughtFish then
        if amount == 5 then
            if fishinglocation6active then                                                     -- If at Ocean Spot
                ...
                TriggerEvent("DoLongHudText","Your net caught you a FUCKING DOLPHIN!",1)
                else                                                                           -- If Doesnt Have Fishing Net
                    TriggerEvent("player:receiveItem",'fishingnet', 1)  
                    TriggerEvent("DoLongHudText","You managed to catch a rogue fishing net!",1)
                end
            else       
                if exports["np-inventory"]:hasEnoughOfItem("illegalhook", 1) then  
                    hookamount = math.random(2,3)                                                  --If Not At Ocean Spot + Has Hook
                      TriggerEvent("player:receiveItem",'fishingflounder', hookamount)
                      TriggerEvent("DoLongHudText","Your hook caught you some extra flounder!",1)
                else                                                                                -- If Not At Ocean Spot + No Hook
                    TriggerEvent("player:receiveItem",'fishingflounder', 1)
                    TriggerEvent("DoLongHudText","You managed to catch a flounder!",1)
                end
            end
        end
    ...
    if caughtFish then
        if amount == 6 then
            if fishinglocation6active then                                                     -- If at Ocean Spot
                ...
                TriggerEvent("DoLongHudText","Your net caught you a FUCKING SHARK!",1)
                else                                                                           -- If Doesnt Have Fishing Net
                    TriggerEvent("player:receiveItem",'fishingnet', 1)  
                    TriggerEvent("DoLongHudText","You managed to catch a rogue fishing net!",1)
                end
                ...
                if exports["np-inventory"]:hasEnoughOfItem("illegalhook", 1) then  
                    hookamount = math.random(2,3)                                                  --If Not At Ocean Spot + Has Hook
                      TriggerEvent("player:receiveItem",'fishingmackerel', hookamount)
                      TriggerEvent("DoLongHudText","Your hook caught you some extra mackerel!",1)
                else                                                                                -- If Not At Ocean Spot + No Hook
                    TriggerEvent("player:receiveItem",'fishingmackerel', 1)
                    TriggerEvent("DoLongHudText","You managed to catch a mackerel!",1)
                end
            end
        end
    ...
    if caughtFish then
        if amount == 7 then
            if fishinglocation6active then                                                     -- If at Ocean Spot
                if exports["np-inventory"]:hasEnoughOfItem("fishingnet", 1) then               -- If Has Fishing Net 
                TriggerEvent("player:receiveItem",'fishingsturgeon', 1)
                TriggerEvent("DoLongHudText","Your net caught you a Sturgeon!",1)
                else                                                                           -- If Doesnt Have Fishing Net
                    TriggerEvent("player:receiveItem",'illegalhook', 1)  
                    TriggerEvent("DoLongHudText","You managed to catch a rogue fishing hook!",1)
                end
            else       
                if exports["np-inventory"]:hasEnoughOfItem("illegalhook", 1) then  
                    hookamount = math.random(2,3)                                                  --If Not At Ocean Spot + Has Hook
                      TriggerEvent("player:receiveItem",'fishingcod', hookamount)
                      TriggerEvent("DoLongHudText","Your hook caught you some extra cod!",1)
                else                                                                                -- If Not At Ocean Spot + No Hook
                    TriggerEvent("player:receiveItem",'fishingcod', 1)
                    TriggerEvent("DoLongHudText","You managed to catch a cod!",1)
                end
            end
        end
    ...
    if caughtFish then
        if amount == 8 then
                      TriggerEvent("player:receiveItem",'fishingboot', 1)
                      TriggerEvent("DoLongHudText","You managed to catch a boot!",1)
        end  
    else
        TriggerEvent("DoLongHudText","The fish got loose!",2)
    end
    ...
    if caughtFish then
        if amount == 9 then
                      ...
                      TriggerEvent("DoLongHudText","You managed to catch a log!",1)
        end  
    else
        TriggerEvent("DoLongHudText","The fish got loose!",2)
    end
    ...
    if caughtFish then
        if amount == 10 then
                      TriggerEvent("player:receiveItem",'fishingtin', 1)
                      TriggerEvent("DoLongHudText","You managed to catch a tin can!",1)
        end  
    else
        TriggerEvent("DoLongHudText","The fish got loose!",2)
    end
    ...
    function netTeir()
        if exports["np-inventory"]:hasEnoughOfItem("fishingrod2", 1) then  
            luckchance = math.random(2,3)                                                  --If Not At Ocean Spot + Has Hook
              TriggerEvent("player:receiveItem",'fishingcod', hookamount)
              TriggerEvent("DoLongHudText","Your hook caught you some extra cod!",1)
        else                                                                                -- If Not At Ocean Spot + No Hook
            TriggerEvent("player:receiveItem",'fishingcod', 1)
...
RoyalZoneFishing6 = false
fishinglocation6active = false

Citizen.CreateThread(function()
    exports["np-polyzone"]:AddBoxZone("fishing_zone_6", vector3(4175.01, 4517.42, 2.99), 75, 19.8, {
        name="fishing_zone_6",
        heading=265,
        -- debugPoly=true,
        minZ=0.21,
...
RegisterNetEvent('np-polyzone:enter')
AddEventHandler('np-polyzone:enter', function(name)
    if name == "fishing_zone_6" and fishinglocation6active then
        RoyalZoneFishing6 = true     
    end
end)
...
AddEventHandler('np-fishing:sell', function()
    local data = {
        {
            title = "Fishing Sales",
            description = "Sell Your Latest Catches"
        },
        {
            title = "Basic Fish",
            children = {
                {
                    title = "Bass",
                    description = "Sell All Your Bass",
                    action = "np-sanitation:starting"
                },
                {
                    title = "Mackerel",
                    description = "Sell All Your Mackerel",
                    action = "np-sanitation:ending"
                },
                {
                    title = "Start Run",
                    description = "Begin A Sanitation Run",
                    action = "np-sanitation:starting"
                },
            ...
            children = {
                {
                    ...
                    description = "Opens Trade In Menu",
                    action = "np-santiation:mattrade"
                },
...
AddEventHandler("np-fishing:shop", function()
    TriggerEvent("server-inventory-open", "534", "Shop")
end)

AddEventHandler("np-fishing:tshop", function()
    TriggerEvent("server-inventory-open", "535", "Craft")
end)
...
local data = {
    {
        title = "Fishing Options",
        description = "Choose your lucky spot!"
    },
    {
        ...
        children = {
            {
                ...
                action = "np-fishing:select_zone_1"
            },
            {
                title = "Zone 2",
                description = "Sandy Shores",
                action = "np-fishing:select_zone_2"
            },
            {
                title = "Zone 3",
                description = "Sandy Shores",
                action = "np-fishing:select_zone_3"
            },
            {
                title = "Zone 4",
                description = "Sandy Shores",
                action = "np-fishing:select_zone_4"
            },
            {
                title = "Zone 5",
                description = "Sandy Shores",
                action = "np-fishing:select_zone_5"
            },
    ...
    },
    {
        ...
        children = {
            {
                title = "Ocean Fishing",
                description = "Requires Fishing Pass & Teir 2 Rod",
                action = "np-fishing:select_zone_6"
            },
    ...
    },
    {
        ...
        children = {
            {
                title = "Fishing Shop",
                description = "Access Supply Shop",
                action = "np-fishing:shop"
            },
...
RegisterNetEvent('np-fishing:zone6fee')
AddEventHandler('np-fishing:zone6fee', function()
TriggerServerEvent("np-fishing:cashcheck")
end)

RegisterNetEvent('np-fishing:select_zone_6')
AddEventHandler('np-fishing:select_zone_6', function()
    if exports['np-inventory']:hasEnoughOfItem('fishingpass', 1) and exports['np-inventory']:hasEnoughOfItem('fishingrod2', 1) then
    fishinglocation6active = true
    SetNewWaypoint(4175.01, 4517.42, 2.9946)
    TriggerEvent('DoLongHudText', 'Your GPS was updated go to the area and fish', 1)
    else
    TriggerEvent('DoLongHudText', 'You dont seem to have a fishing pass', 2)
    end
end)