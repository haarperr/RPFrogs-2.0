...
AddEventHandler("np-police:showVehicles", function(pArgs, pEntity, pContext)
    local data = {}
...
AddEventHandler("np-police:purchaseVehicle", function(params)
    ...
    TriggerServerEvent("np-police:purchaseVehicle", params)
end)
