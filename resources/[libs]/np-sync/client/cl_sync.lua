TriggerServerEvent("np-sync:playerReady")

RegisterNetEvent("np-sync:execute")
AddEventHandler("np-sync:execute", function(native, netID, ...)
...
function syncNative(native, netEntity, options, ...)
    TriggerServerEvent("np-sync:executeSyncNative", native, netEntity, options, table.pack(...))
end
