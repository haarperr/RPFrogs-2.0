...
Citizen.CreateThread(function()
    ...
    exports["np-eye"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall', {{
    ...
    exports["np-eye"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall_second', {{
        event = "np-heists:cocaine:failure",
    ...
    exports["np-eye"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall_third', {{
        event = "np-heists:cocaine:failure",
    ...
    exports["np-eye"]:AddPeekEntryByPolyTarget('heist_cocaine_phonecall_four', {{
