...
$(document).ready(() => {
    ...
    $(".profile-items").on("click", ".profile-item", function () {
        let id = $(this).data("id");
        $.post('https://np-mdt/getProfileData', JSON.stringify({
            id: id
        }));
    })
    ...
    $(".bulletin-add-btn").click(function () {
        if (canCreateBulletin == 0) {
            ...
            $('.bulletin-items-continer').prepend(`<div class="bulletin-item" data-id="${canCreateBulletin}">
                ...
                <div class="bulletin-date">${MyName} - Now</div>
                </div>
            </div>`)
        } else {
    ...
    $(".bulletin-items-continer").on("keydown", ".bulletin-item", function (e) {
        if (e.keyCode === 13) {
            ...
            let time = new Date()
            $.post('https://np-mdt/newBulletin', JSON.stringify({
                title: title,
                info: info,
                time: time.getTime()
            }));
    ...
    $(".contextmenu").on("click", ".remove-bulletin", function () {
        ...
        $.post('https://np-mdt/deleteBulletin', JSON.stringify({
            id: BulletinId,
            time: time.getTime()
        }));
        ...
        if (e.keyCode === 13) {
            ...
            if (URL !== "") {
                ...
                setTimeout(() => {
                    ...
                    $.post('https://np-mdt/addGalleryImg', JSON.stringify({
                        cid: cid,
                        URL: URL
                    }));
                }, 250);
    ...
    $(".manage-profile-save").click(function () {
        if (canSaveProfile == true) {
            ...
            setTimeout(() => {
                ...
                $.post('https://np-mdt/saveProfile', JSON.stringify({
                    pfp: pfp,
    ...
    $(".manage-incidents-title-holder").on("click", ".manage-incidents-save", function () {
        if (canSaveProfile == true) {
            ...
            $.post('https://np-mdt/saveIncident', JSON.stringify({
                ID: dbid,
                title: title,
            ...
            setTimeout(() => {
                if (canRefreshIncidents == true) {
                    ...
                    setTimeout(() => {
                        ...
                        $.post('https://np-mdt/getAllIncidents', JSON.stringify({}));
                    }, 1500);
                }
            }, 1000);
    ...
    $(".manage-incidents-title-holder").on("click", ".manage-incidents-create", function () {
        if ($(".badge-logo").attr('src') == 'https://cdn.discordapp.com/attachments/770324167894761522/912602342275301396/ems_badge.png') {
            ...
            $(".manage-incidents-reports-content").val("📝 summary:\n\n[Insert a report summary here]\n\n🧍 Hostage: [Name Here]\n\n🔪 Weapons/Items confiscated:\n\n· [List here]\n\n-----\n💸 Traffic Ticket:\n⌚ Verdict:\n-----");
            $("#manage-incidents-title-input").val("Name - Incident - " + $(".date").html());
            $(".manage-incidents-editing-title").html("You are creating a new Incident");
            $(".manage-incidents-title-holder").empty();
            $(".manage-incidents-title-holder").prepend(
                `
                <div class="manage-incidents-title">Incident</div>
                <div class="manage-incidents-create"> <span class="fas fa-plus" style="margin-top: 3.5px;"></span></div>
                <div class="manage-incidents-save"><span class="fas fa-save" style="margin-top: 3.5px;"></span></div>
                `
            );
    ...
    $(".contextmenu").on("click", ".search-vehicle", function () {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                $.post('https://np-mdt/searchVehicles', JSON.stringify({
                    name: plate.toString()
                }));
                $(".dmv-items").empty();
                $('.dmv-items').prepend(`<div class="profile-loader"></div>`);
                setTimeout(() => {
                    $.post('https://np-mdt/getVehicleData', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".search-weapon", function () {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                $.post('https://np-mdt/searchWeapon', JSON.stringify({
                    name: plate.toString()
                }));
                $(".weapons-items").empty();
                $('.weapons-items').prepend(`<div class="profile-loader"></div>`);
                setTimeout(() => {
                    $.post('https://np-mdt/getWeaponData', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".search-house", function () {
        ...
        $.post('https://np-mdt/searchHouse', JSON.stringify({
    ...
    //     $.post('https://np-mdt/updateLicence', JSON.stringify({
    ...
    $('#profile-search-input').keydown(function (e) {
        if (e.keyCode === 13 && canSearchForProfiles == true) {
            ...
            if (name !== "") {
                ...
                $.post('https://np-mdt/searchProfiles', JSON.stringify({
                    name: name
                }));
                $(".profile-items").empty();
    ...
    $('#incidents-search-input').keydown(function (e) {
        if (e.keyCode === 13 && canSearchForProfiles == true) {
            ...
            if (incident !== "") {
                canSearchForProfiles = false
                $.post('https://np-mdt/searchIncidents', JSON.stringify({
                    incident: incident
                }));
    ...
    $('#dispatchmsg').keydown(function (e) {
        ...
        if (keyCode === 13 && !e.shiftKey) {
            e.preventDefault()
            const time = new Date()
            $.post('https://np-mdt/dispatchMessage', JSON.stringify({
                message: $(this).val(),
                time: time.getTime()
            }));
            $(this).val("")
    ...
    $(".incidents-items").on("click", ".incidents-item", function () {
        ...
        $.post('https://np-mdt/getIncidentData', JSON.stringify({
            id: id
        }));
    })
    ...
    document.onkeyup = function (data) {
        if (data.which == 27) {
            ...
            if (shouldClose == true) {
                $.post('https://np-mdt/escape', JSON.stringify({}));
            }
        }
    };
    ...
    $(".icidents-person-search-name-input").on("keydown", "", function (e) {
        if (e.keyCode === 13) {
            ...
            $.post('https://np-mdt/incidentSearchPerson', JSON.stringify({
                name: name
            }));
        }
    });
    ...
    $(".manage-bolos-title-holder").on("click", ".manage-bolos-new", function () {
        ...
        $(".manage-bolos-editing-title").html("You are creating a new BOLO")
    ...
    $(".manage-bolos-title-holder").on("click", ".manage-bolos-save", function () {
        let existing = !($(".manage-bolos-editing-title").html() == 'You are creating a new BOLO')
        ...
        $.post('https://np-mdt/newBolo', JSON.stringify({
            existing: existing,
            id: id,
            title: title,
            plate: plate,
    ...
    $('#bolos-search-input').keydown(function (e) {
        if (e.keyCode === 13 && canSearchForProfiles == true) {
            ...
            if (searchVal !== "") {
                canSearchForProfiles = false
                $.post('https://np-mdt/searchBolos', JSON.stringify({
                    searchVal: searchVal
                }));
                $(".bolos-items").empty();
    ...
    $(".bolos-search-refresh").click(function () {
        if (canRefreshBolo == true) {
            ...
            setTimeout(() => {
                ...
                canRefreshBolo = true
                $.post('https://np-mdt/getAllBolos', JSON.stringify({}));
            }, 1500);
        }
    });
    ...
    $(".bolos-items").on("click", ".bolo-item", function () {
        ...
        canInputBoloOfficerTag = true
        let id = $(this).data("id");
        $.post('https://np-mdt/getBoloData', JSON.stringify({
            id: id
        }));
    })
    ...
    $(".contextmenu").on("click", ".bolo-delete", function () {
        ...
        if ($(this).data("info") != 0) {
            if ($(".badge-logo").attr('src') == 'https://cdn.discordapp.com/attachments/770324167894761522/912602342275301396/ems_badge.png') {
                ...
                $.post('https://np-mdt/deleteICU', JSON.stringify({
                    id: $(this).data("info"),
                    time: new Date().getTime()
                }));
            }
            $(".bolos-items").find("[data-id='" + $(this).data("info") + "']").remove();
            $.post('https://np-mdt/deleteBolo', JSON.stringify({
                id: $(this).data("info"),
                time: new Date().getTime()
            }));
        }
    ...
    $(".contextmenu").on("click", ".incident-delete", function () {
        ...
        $.post('https://np-mdt/deleteIncident', JSON.stringify({
            id: $(this).data("info"),
            time: new Date().getTime()
        }));
    });
    ...
    $(".contextmenu").on("click", ".missing-delete", function () {
        ...
        $.post('https://np-mdt/deleteMissing', JSON.stringify({
            id: $(this).data("info"),
            time: new Date().getTime()
        }));
    });
    ...
    $(".contextmenu").on("click", ".profile-missing", function () {
        $.post('https://np-mdt/missingCitizen', JSON.stringify({
            cid: $(this).data("info"),
            time: new Date().getTime()
        }));
    });
    ...
    $(".contextmenu").on("click", ".report-delete", function () {
        ...
        $.post('https://np-mdt/deleteReport', JSON.stringify({
            id: $(this).data("info"),
            time: new Date().getTime()
        }));
    });
    ...
    $(".contextmenu").on("click", ".add-charge", function () {
        ...
        $.post('https://np-mdt/getPenalCode', JSON.stringify({}));
    });
    ...
    $(".contextmenu").on("click", ".associated-incidents-remove-tag", function () {
        ...
        if (incidentId != 0) {
            $.post('https://np-mdt/removeIncidentCriminal', JSON.stringify({
            ...
            if ($(".badge-logo").attr('src') == 'https://cdn.discordapp.com/attachments/770324167894761522/912602342275301396/ems_badge.png') {
                $(".incidents-ghost-holder").prepend(
                    ...
                    <div class="associated-incidents-user-container" data-id="${$(this).data("cid")}">
                        ...
                        <div class="associated-incidents-fine-input" data-id="${$(this).data("cid")}"><img src="https://i.imgur.com/h7S5f9J.png"> <input placeholder="Put the fine here..." value="0" class="fine-amount" data-id="${$(this).data("cid")}" type="number"></div>
                    </div>
                    `
                );
            } else {
                $(".incidents-ghost-holder").prepend(
                    ...
                    <div class="associated-incidents-user-container" data-id="${$(this).data("cid")}">
                        ...
                        <div class="associated-incidents-user-tags-holder">
                            ...
                            <div class="associated-incidents-user-tag red-tag" data-id="${$(this).data("cid")}">Processed</div>
                            <div class="associated-incidents-user-tag red-tag" data-id="${$(this).data("cid")}">Associates</div>
                        </div>
                        <div class="associated-incidents-user-holder" data-name="${$(this).data("cid")}">
                        </div>
                        <div class="manage-incidents-title-tag" data-id="${$(this).data("cid")}">Recommended Fine</div>
                        ...
                        <div class="associated-incidents-sentence-input" data-id="${$(this).data("cid")}"><img src="https://i.imgur.com/9Xn6xXK.png"> <input placeholder="Put the fine here.." value="0" class="sentence-amount" data-id="${$(this).data("cid")}" type="number"></div>
                    </div>
                    `
                );
            }
    ...
    $(".contextmenu").on("click", ".incidents-remove-normal-tag", function () {
        ...
        let cid = $(".manage-profile-citizenid-input").val();
        if (cid) {
            $.post('https://np-mdt/removeProfileTag', JSON.stringify({
                cid: cid,
                text: $(this).data("info")
            }));
        }
    ...
    $(".reports-search-refresh").click(function () {
        if (canRefreshReports == true) {
            ...
            setTimeout(() => {
                ...
                $.post('https://np-mdt/getAllReports', JSON.stringify({}));
            }, 1500);
        }
    });
    $(".dispatch-comms-refresh").click(function () {
        ...
        setTimeout(() => {
            ...
            canRefreshReports = true
            $.post('https://np-mdt/refreshDispatchMsgs', JSON.stringify({}));
        }, 1500);
    })
    $(".reports-items").on("click", ".reports-item", function () {
        ...
        let id = $(this).data("id");
        $.post('https://np-mdt/getReportData', JSON.stringify({
            id: id
        }));
    })
    ...
    $(".manage-reports-title-holder").on("click", ".manage-reports-new", function () {
        $(".manage-reports-editing-title").html("You are creating a new report")
    ...
    $('#reports-search-input').keydown(function (e) {
        if (e.keyCode === 13 && canSearchForReports == true) {
            ...
            if (name !== "") {
                ...
                $.post('https://np-mdt/searchReports', JSON.stringify({
                    name: name
                }));
                $(".reports-items").empty();
    ...
    $(".manage-reports-title-holder").on("click", ".manage-reports-save", function () {
        let existing = !($(".manage-reports-editing-title").html() == 'You are creating a new report')
        ...
        $.post('https://np-mdt/newReport', JSON.stringify({
            existing: existing,
            id: id,
            title: title,
            type: type,
    ...
    $('#missing-search-input').keydown(function (e) {
        if (e.keyCode === 13) {
            ...
            if (name !== "") {
                $.post('https://np-mdt/searchMissing', JSON.stringify({
                    name: name
                }));
                $(".missing-items").empty();
    ...
    $(".missing-items").on("click", ".missing-item", function () {
        $.post('https://np-mdt/getMissingData', JSON.stringify({
            id: $(this).data("dbid")
        }));
    });
    ...
    $(".vehicle-information-title-holder").on("click", ".vehicle-information-save", function () {
        if (canSaveVehicle) {
            ...
            setTimeout(() => {
                ...
                $.post('https://np-mdt/saveVehicleInfo', JSON.stringify({
                    dbid: dbid,
                    plate: plate,
                    imageurl: imageurl,
                    notes: notes
    ...
    $(".weapon-information-title-holder").on("click", ".weapon-information-save", function () {
        if (canSaveVehicle) {
            ...
            setTimeout(() => {
                ...
                $.post('https://np-mdt/saveWeaponInfo', JSON.stringify({
                    dbid: dbid,
    ...
    $(".missing-information-title-holder").on("click", ".missing-information-save", function () {
        if (canSaveVehicle) {
            ...
            setTimeout(() => {
                ...
                $.post('https://np-mdt/saveMissingInfo', JSON.stringify({
                    id: dbid,
                    last_seen: last_seen,
                    imageurl: imageurl,
                    notes: notes
    ...
    $(".contextmenu").on("click", ".mark-code-5", function () {
        ...
        if (tag.hasClass("red-tag")) {
            ...
            $.post('https://np-mdt/knownInformation', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".toggle-duty", function () {
        ...
        if (currentStatus == "10-8") {
            ...
            $.post('https://np-mdt/toggleDuty', JSON.stringify({
                cid: info,
                status: 0
            }));
    ...
    $(".contextmenu").on("click", ".set-waypoint", function () {
        let info = $(this).data("info")
        $.post('https://np-mdt/setWaypointU', JSON.stringify({
            cid: info,
        }));
    })
    ...
    $(".contextmenu").on("click", ".set-waypoint", function () {
        ...
        $.post('https://np-mdt/setWaypoint', JSON.stringify({
            callid: callId,
        }));
    })
    ...
    $(".contextmenu").on("click", ".call-attach", function () {
        const callId = $(this).data("info")
        $.post('https://np-mdt/callAttach', JSON.stringify({
            callid: callId,
        }));
    })
    ...
    $(".contextmenu").on("click", ".call-detach", function () {
        const callId = $(this).data("info")
        $.post('https://np-mdt/callDetach', JSON.stringify({
            callid: callId
        }));
    })
    ...
    $(".contextmenu").on("click", ".remove-call", function () {
        ...
        $.post('https://np-mdt/removeCall', JSON.stringify({
            callid: callId
        }));
    })
    ...
    $(".contextmenu").on("click", ".attached-units", function () {
        const callId = $(this).data("info")
        $.post('https://np-mdt/attachedUnits', JSON.stringify({
            callid: callId
        }));
    })
    ...
    $('#respondcalls').keydown(function (e) {
        ...
        if (keyCode === 13 && !e.shiftKey) {
            ...
            e.preventDefault();
            const time = new Date()
            $.post('https://np-mdt/sendCallResponse', JSON.stringify({
                message: $(this).val(),
                time: time.getTime(),
                callid: callid
            }));
    ...
    $(".contextmenu").on("click", ".respond-call", function () {
        const callId = $(this).data("info")
        $.post('https://np-mdt/getCallResponses', JSON.stringify({
            callid: callId
        }));
    ...
    $(".contextmenu").on("click", ".call-dispatch-detach", function () {
        const cid = $(this).data("info")
        $.post('https://np-mdt/callDispatchDetach', JSON.stringify({
    ...
    $(".contextmenu").on("click", ".Set-Dispatch-Waypoint", function () {
        const cid = $(this).data("info")
        $.post('https://np-mdt/setDispatchWaypoint', JSON.stringify({
            callid: $(".dispatch-attached-units-container").attr("id"),
            cid: cid
        }));
    })
    ...
    $(".jail-buttons").on("click", ".jail-submit", function () {
        ...
        if (time.length > 0) {
            ...
            $.post('https://np-mdt/jailPlayer', JSON.stringify({
                cid: cid,
                time: time
            }));
            $(".jail-inner-container").slideUp(500)
    ...
    $(".dna-buttons").on("click", ".dna-submit", function () {
        ...
        if (dna.length == 7) {
            ...
            $.post('https://np-mdt/dnaEdit', JSON.stringify({
                cid: cid,
                dna: dna
            }));
            $(".dna-inner-container").slideUp(500)
    ...
    $(".callsign-buttons").on("click", ".callsign-submit", function () {
        ...
        if (callsign.length > 2) {
            ...
            $.post('https://np-mdt/setCallsign', JSON.stringify({
                cid: editingcallsign,
    ...
    $(".active-calls-list").on("click", ".active-calls-item", function (e) {
        ...
        if (callId && draggedElement) {
            $.post('https://np-mdt/callDragAttach', JSON.stringify({
                callid: callId,
                cid: draggedElement
            }));
            draggedElement = 0
    ...
    function JobColors(sentJob) {
        ...
        if (sentJob) {
            ...
            if (["police", "sheriff", "state_police", "park_ranger", "cid"].includes(sentJob)) {
                ...
                $(".quote-span").html("Law above All. TriHard 7");
                $(".dispatch-title-ofsomesort").html("Messages");
                ...
                $(".incidents-title").html(`<span class="fas fa-search"></span> INCIDENTS`);
                $("#incidents-search-input").attr('placeholder', 'Search Incident...');
                $(".manage-incidents-reports-content").attr('placeholder', 'The contents of the incidents report go here...');
                $(".manage-incidents-title").html("Incident");
                $(".manage-incidents-editing-title").html("You are creating a new incident");
                ...
                $("#bolos-search-input").attr('placeholder', 'search for BOLO...');
                $(".manage-bolos-title").html("BOLO");
                $(".manage-bolos-editing-title").html("You are creating a new BOLO");
                $(".boloplate-title").html("Plate");
                $(".boloowner-title").html("Owner");
                $(".boloindividual-title").html("Individual");
                $("#boloplate").attr('placeholder', 'Put the plate here...');
                $("#bolodetail").attr('placeholder', 'Place BOLO details Here...');
                $("#boloowner").attr('placeholder', 'Put vehicle owner here...');
                $("#boloindividual").attr('placeholder', 'Put the Individual here...');
                ...
                $(".quote-span").html("In FFRP we belive");
                $(".dispatch-title-ofsomesort").html("Messages")
                ...
                $(".quote-span").html("In FFRP We Believe 🐒");
                $(".dispatch-title-ofsomesort").html("Messages")
    ...
    window.addEventListener('message', function (event) {
        ...
        if (e.type == "show") {
            ...
            $.post('https://np-mdt/getAllProfiles', JSON.stringify({}));
        } else if (e.type == "data") {
            ...
            if ((BodyDisplay) == "block") {
                ...
                $.post('https://np-mdt/dispatchNotif', JSON.stringify({
                    data: value,
                }));
            }
            $('.dispatch-items').scrollTop($('.dispatch-items')[0].scrollHeight)
            ...
            if ($(".badge-logo").attr('src') == 'https://cdn.discordapp.com/attachments/770324167894761522/912602342275301396/ems_badge.png') {
                $(".manage-incidents-editing-title").html("You are currently editing the Incident Report" + table["id"]);
            } else {
                $(".manage-incidents-editing-title").html("VYou are currently editing the Incident Report " + table["id"]);
            }
                    ...
                    if (value.isassociated) {
                        $(".incidents-ghost-holder").prepend(
                            `<div class="associated-incidents-user-container" data-id="${value.cid}">
                                ...
                                <div class="associated-incidents-fine-input" data-id="${value.cid}" style="display:none;"><img src="https://i.imgur.com/h7S5f9J.png"> <input placeholder="Put the fine here..." value="0" class="fine-amount" data-id="${value.cid}" type="number"></div>
                            </div>`
                        );
                    } else {
                        $(".incidents-ghost-holder").prepend(
                            `<div class="associated-incidents-user-container" data-id="${value.cid}">
                                ...
                                <div class="associated-incidents-fine-input" data-id="${value.cid}"><img src="https://i.imgur.com/h7S5f9J.png"> <input placeholder="Put the fine here..." value="0" class="fine-amount" data-id="${value.cid}" type="number"></div>
                            </div>`
                        );
                    }
                } else {
                        ...
                        $(".incidents-ghost-holder").prepend(
                            `<div class="associated-incidents-user-container" data-id="${value.cid}">
                                ...
                                <div class="associated-incidents-user-tags-holder">
                                    ...
                                    <div class="associated-incidents-user-tag ${associatedTag}" data-id="${value.cid}">Associates</div>
                                </div>
                                <div class="associated-incidents-user-holder" data-name="${value.cid}" style="display:none;">
                                </div>
                                <div class="manage-incidents-title-tag" data-id="${value.cid}" style="display:none;">Recommended Fine</div>
                                ...
                                <div class="associated-incidents-sentence-input" data-id="${value.cid}" style="display:none;"><img src="https://i.imgur.com/9Xn6xXK.png"> <input placeholder="Put the fine here.." value="0" class="sentence-amount" data-id="${value.cid}" type="number"></div>
                            </div>`
                        );
                    } else {
                        $(".incidents-ghost-holder").prepend(
                            `<div class="associated-incidents-user-container" data-id="${value.cid}">
                                ...
                                <div class="associated-incidents-sentence-input" data-id="${value.cid}"><img src="https://i.imgur.com/9Xn6xXK.png"> <input placeholder="Put the fine here.." value="0" class="sentence-amount" data-id="${value.cid}" type="number"></div>
                            </div>`
                        );
                    }
                }
            ...
            let table = e.data
            $(".manage-bolos-editing-title").html("You are editing the BOLO " + table["id"]);
                ...
                <div class="missing-item" data-id="${value.id}" data-dbid="${value.id}" data-cid="${value.cid}">
                    ...
                    <div style="display: flex; flex-direction: column;">
                        ...
                        <div class="missing-bottom-info">
                            <div class="missing-id">ID: ${value.id} · Last Seen: ${value.last_seen}</div>
                        </div>
                    </div>
                </div>
                `)
            ...
            $(".manage-bolos-editing-title").html("You are editing the BOLO " + id);
            ...
            $(".manage-reports-editing-title").html("You are editing the report " + id);
            ...
            $(".manage-reports-editing-title").html("You are editing the report " + table["id"]);
...
function fidgetSpinner(page) {
    ...
    if (page == '.missing-page-container') {
        $.post('https://np-mdt/getAllMissing', JSON.stringify({}));
    }
    if (page == '.reports-page-container') {
        $.post('https://np-mdt/getAllReports', JSON.stringify({}));
    }
    if (page == '.stafflogs-page-container') {
        $.post('https://np-mdt/getAllLogs', JSON.stringify({}));
    }
    if (page == '.incidents-page-container') {
        $.post('https://np-mdt/getAllIncidents', JSON.stringify({}));
    }
    if (page == '.dmv-page-container') {
        $.post('https://np-mdt/getAllVehicles', JSON.stringify({}));
    }
    if (page == '.weapons-page-container') {
        $.post('https://np-mdt/getAllWeapons', JSON.stringify({}));
    }
...
function addTag(tagInput) {
    ...
    $.post('https://np-mdt/newTag', JSON.stringify({
...
function addWeapon(Input) {
    ...
    $.post('https://np-mdt/newWeapon', JSON.stringify({
        id: $(".manage-profile-citizenid-input").val(),
        serialnumber: Input
    }));
}
...
function removeImage(url) {
    ...
    $.post('https://np-mdt/removeGalleryImg', JSON.stringify({
        cid: cid,
        URL: url
    }));
}
