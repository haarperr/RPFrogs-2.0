...
AddEventHandler("np-admin_newest:noClipToggle", function(pIsEnabled)
...
RegisterCommand("+addAdminNoClip", function()
  noClipEnabled = not noClipEnabled
  inputRotEnabled = not inputRotEnabled
...
Citizen.CreateThread(function()
  exports["np-keybinds"]:registerKeyMapping("", "Admin", "NoClip", "+addAdminNoClip", "-addAdminNoClip")
end)