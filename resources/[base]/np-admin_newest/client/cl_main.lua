RegisterNetEvent('np-admin_newest:try-open-menu', function(OnPress)
...
RegisterNetEvent('np-admin_newest:forceClose', function()
...
RegisterNUICallback('Admin/GetCharData', function(Data, Cb)
    local CharData = RPC.execute('np-admin_newest:getChardata', Data.License)
end)
