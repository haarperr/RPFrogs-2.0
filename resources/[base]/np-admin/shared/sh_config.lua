...
Config.AdminMenus = {
    {
        ...
        ['Items'] = {
            ...
            {
                ['Id'] = 'money',
                ['Name'] = 'Money add/remove',
                ['Event'] = 'Admin:Money:state',
                ['Collapse'] = true,
                ['Options'] = {
                    {
                        ['Id'] = 'player',
