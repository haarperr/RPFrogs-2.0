RegisterNetEvent("np-racing:recieveCreateData")
AddEventHandler("np-racing:recieveCreateData", function(pRaceName, pRaceType, pRaceThumbnail, pCheckpoints)
    local src = source

    local aliases = exports["np-base"]:getChar(src, "aliases")
    ...
    TriggerClientEvent("np-racing:addedRace", -1, {}, Races)
    TriggerClientEvent("DoLongHudText", src, "Race " .. pRaceName .. " created!")
end)

RPC.register("np-racing:isRaceNameTaken", function(src, pRaceName)
